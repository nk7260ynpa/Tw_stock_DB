...
台灣股市資料庫建構工具，建立 6 個 MySQL 資料庫（TWSE、TPEX、TAIFEX、NEWS、INFO、SPECIAL_INFO），
...
│   ├── news.py              # NEWS 資料庫實作
│   ├── info.py              # INFO 資料庫實作
│   ├── special_info.py      # SPECIAL_INFO 資料庫實作
...
│       ├── test_news.py     # news.py 單元測試
│       ├── test_info.py     # info.py 單元測試
│       └── test_special_info.py  # special_info.py 單元測試
└── logs/                    # 日誌輸出目錄
```
