...
if __name__ == "__main__":
    ...
    parser.add_argument("--dbname", type=str, choices=["TWSE", "TPEX", "TAIFEX", "FAOI", "MGTS"], default="TWSE", 
                        help="MySQL database name (choose between 'TWSE' and 'TPEX' and 'TAIFEX' and 'FAOI' and 'MGTS')")
